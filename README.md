...
- **M5Stack Cardputer 用 Share Code:** `wB0nx3yONQ6uNYU0`
- **M5Stack Atom Echo S3R 用 Share Code:** `PETvTzcjDHAx9WP8`
...
- **Enter キー**: 曲の再生を開始 (Play Selected Track)
- **Space キー**: 再生を停止し、ファイル選択画面に戻る (Stop and return to menu)
- **= キー**: 音量を上げる (Volume Up)
...
- [美咲フォント (Misaki Font)](https://littlelimit.net/misaki.htm) by 8:51:22 pm / Little Limit - Free Font License
...
- **M5Stack Cardputer Share Code:** `wB0nx3yONQ6uNYU0`
- **M5Stack Atom Echo S3R Share Code:** `PETvTzcjDHAx9WP8`
...
- **Space Key**: Stop playback and return to file selection
- **= Key**: Volume Up
- **- Key**: Volume Down
...
- ESP-IDF (FFat / Wear Levelling) - Apache License 2.0
- Puff (zlib decompressor) by Mark Adler - zlib License
- [Misaki Font](https://littlelimit.net/misaki.htm) by 8:51:22 pm / Little Limit - Free Font License
